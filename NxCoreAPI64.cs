...
namespace NxCoreAPI
{
  ...
  #region NxDate, NxTime, NxString
    ...
    {
      [FieldOffset(0)]
      public Int32 UserData1;  // first  32-bit user data space.
      [FieldOffset(4)]
    ...
    [StructLayout(LayoutKind.Explicit, CharSet = CharSet.Ansi, Size = 104)]
    ...
    // NxCoreTrade    
    [StructLayout(LayoutKind.Explicit, CharSet = CharSet.Ansi, Size = 88)]   // must force the size, or it becomes 88
    ...
    {   // 84 bytes.
      ...
      [FieldOffset(84)]
      unsafe public fixed byte ExtTradeConditions[4];
    };
    ...
    // NxCore3Ext    
    [StructLayout(LayoutKind.Explicit, CharSet = CharSet.Ansi, Size = 24)]
    public struct NxCore3Ext
    {
      [FieldOffset(0)]
      public System.UInt64 MicrosOfDaySRC;
      [FieldOffset(8)]
      public System.UInt64 MicrosOfDayPTP1;
      [FieldOffset(16)]
      public System.UInt64 MicrosOfDayPTP2;
    };

    // NxCoreMessage    
    [StructLayout(LayoutKind.Explicit, CharSet = CharSet.Ansi, Size = 156)] // 32bit=140 bytes 64bit=148
    public struct NxCoreMessage
    {
        ...
        [FieldOffset(148)]
        unsafe public fixed byte alignment[4];
        [FieldOffset(152)]
        unsafe public NxCore3Ext* pnxCore3Ext;
    };
    ...
    [StructLayout(LayoutKind.Explicit, CharSet = CharSet.Ansi, Size = 488)]
	...
	public class NxCore
  {
    ...
    public const byte NxCORESTATUS_TAPEOPEN = 10;		  // The NxCore tape is loaded
